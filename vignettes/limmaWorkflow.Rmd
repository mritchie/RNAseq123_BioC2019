...
bibliography: "`r system.file(package='RNAseq123', 'vignettes', 'bibliography.bib')`"
---
# RNA-seq analysis is easy as 1-2-3 with limma, Glimma and edgeR

`r knitr::include_graphics(system.file(package='RNAseq123', 'vignettes', 'stickers.png'))`

## Instructor name and contact information

* Matthew E. Ritchie (mritchie@wehi.edu.au), Epigenetics and Development Division, The Walter and Eliza Hall Institute of Medical Research, Parkville, Australia

## Workshop Description

In this workshop, we follow the analysis pipeline described in [Law et al. (2016)](https://doi.org/10.12688/f1000research.9005.3) to analyse RNA-sequencing data from the mouse mammary gland. It begins by demonstrating use of the popular **edgeR** package to import, organise, filter and normalise the data, followed by the **limma** package with its voom method, linear modelling and empirical Bayes moderation to assess differential expression and plot the results. This pipeline is further enhanced by the **Glimma** package which enables interactive exploration of the results so that individual samples and genes can be examined by the user. The complete analysis offered by these three packages highlights the ease with which researchers can turn the raw counts from an RNA-sequencing experiment into biological insights using Bioconductor. Students will be able to follow along and questions are encouraged.
...
<!-- `r knitr::include_graphics(system.file(package='RNAseq123', 'vignettes', 'glMDplot.png'))`
...
```{r camera}
load(system.file("vignettes", "mouse_c2_v5p1.rda", package = "RNAseq123"))
